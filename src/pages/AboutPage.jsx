          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                At LuxeBag, we believe that a great bag is more than just an accessory—it's an investment in your style and confidence. That's why we're committed to offering only the best, backed by our promise of quality, authenticity, and exceptional customer service.
              </p>
            </div>
